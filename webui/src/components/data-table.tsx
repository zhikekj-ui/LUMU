...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  {
    accessorKey: "limit",
    header: () => <div className="w-full text-right">限额</div>,
    cell: ({ row }) => (
      <form
        onSubmit={(e) => {
          e.preventDefault()
  ...
  },
  {
    ...
    header: "审阅人",
    cell: ({ row }) => {
      const isAssigned = row.original.reviewer !== "待分配审阅人"
      ...
      return (
        <>
          ...
          <Select>
            ...
            >
              <SelectValue placeholder="待分配审阅人" />
            </SelectTrigger>
      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            ...
            <SelectItem value="past-performance">过往业绩</SelectItem>
        ...
        <TabsList className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="past-performance">
            过往业绩 <Badge variant="secondary">3</Badge>
          </TabsTrigger>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm">
            <IconPlus />
            <span className="hidden lg:inline">新增区块</span>
          </Button>
        </div>
      </div>
      <TabsContent
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  显示最近 6 个月的访客总量。此处为演示说明文字，用于测试布局在长文本场景下的换行与自适应表现。
                </div>
              </div>
              <Separator />
            </>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                ...
                <Select defaultValue={item.type}>
                  ...
                  <SelectContent>
                    <SelectItem value="封面">封面</SelectItem>
                    <SelectItem value="目录">目录</SelectItem>
                    <SelectItem value="叙述">叙述</SelectItem>
                    <SelectItem value="技术内容">技术内容</SelectItem>
                    <SelectItem value="通俗语言">通俗语言</SelectItem>
